...
public class Song extends AudioContent implements Comparable// implement the Comparable interface
{
	...
	public boolean equals(Object other)
	{
		...
		if(super.equals(other) && this.composer.equals(otherSong.composer) && this.artist.equals(otherSong.artist))
			return true;
		return false;
	}
	...
	public int compareTo(Object other)
	{
		...
		return this.getTitle().compareTo(((Song) other).getTitle());
		// return negative int if other song is > 
		// return positive int if other song is <
	}
}
